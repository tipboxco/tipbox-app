...
import { TrustUser } from '@/src/mock/profile/trustTrusterList/types';
        ...
        >
            ...
            <Popover
                ...
                trigger={(triggerProps) => (
                    ...
                    >
                        <Feather name="more-horizontal" size={24} color={isDark ? '#959595' : '#959595'} />
                    </Pressable>
                )}
            >
                <PopoverBackdrop onPress={onPopoverClose} />
                <PopoverContent width={190} height={160} bg={isDark ? '#1A1A1A' : '#FAFAFA'} borderRadius={5}>
                    <PopoverArrow />
                    <PopoverBody p={0}>
                        <VStack space="xs">
                            {/* Mute Option */}
