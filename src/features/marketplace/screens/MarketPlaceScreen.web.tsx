...
// Web için basit bir View wrapper component (PagerView yerine)
const WebPagerView = React.forwardRef<any, any>((props, ref) => {
  const { children, initialPage, onPageScroll, onPageSelected, ...rest } = props;
...
const AnimatedPagerView = WebPagerView;
  ...
  return (
    <SafeAreaView edges={['top', 'bottom', 'left', 'right']} style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
      <VStack flex={1} bg="#FFFFFF">
        ...
        {/* PagerView - Web için basit View wrapper */}
        <AnimatedPagerView
          ref={pagerRef}
          style={{ flex: 1 }}
          initialPage={0}
