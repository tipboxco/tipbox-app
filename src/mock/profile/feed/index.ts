    ...
    content: [
      {
        ...
        text: 'Got it from Samsung Store during pre-order period. Great unboxing experience, premium packaging. Watch came with 2 band options.',
        rating: [1, 1, 1, 1, 0]
      },
      {
        tag: {
        ...
        text: 'Using it for a month now. Battery life is impressive (3-4 days), health tracking is accurate. The rotating bezel is intuitive. Screen is bright and responsive.',
        rating: [1, 1, 1, 1, 0]
      }
    ],
    stats: {
